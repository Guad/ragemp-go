...
namespace rage
{
	...
	struct time_t
	{
		...
		public:
		static uint8_t GetHour(time_t *time)
		{
			return time->a.hour;
		}

		static uint8_t GetMinute(time_t *time)
		{
			return time->a.minute;
		}

		static uint8_t GetSecond(time_t *time)
		{
			return time->a.second;
		}
	};
	...
	{
	public:
		static IMultiplayer& FromPointer(void *ptr)
		{
			IMultiplayer *mpptr = (IMultiplayer*) ptr;
			IMultiplayer &mp = *mpptr;
			return mp;
		}
